...
public abstract class AbstractRUMState implements RUMState {
    protected static final String BROWSER_TIMING_HEADER_CODE_SNIPPET =
            getMethodInvocationCode("getBrowserTimingHeaderForContentType");
    protected static final String BROWSER_TIMING_FOOTER_CODE_SNIPPET =
            getMethodInvocationCode("getBrowserTimingFooterForContentType");
    ...
    protected static String getMethodInvocationCode(String methodName) {
        ...
        sb.append("  java.lang.Class __nrClass = Class.forName(\"com.newrelic.api.agent.NewRelicApiImplementation\");"
                          + "\n");
        sb.append("  java.lang.reflect.Method __nrMethod = __nrClass.getMethod(\"").append(methodName)
                .append("\", new Class[]{ String.class });\n");
