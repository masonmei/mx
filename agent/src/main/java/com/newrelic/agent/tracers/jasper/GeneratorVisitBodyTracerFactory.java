...
public class GeneratorVisitBodyTracerFactory extends AbstractTracerFactory {
    public Tracer doGetTracer(Transaction transaction, ClassMethodSignature sig, Object visitorObj, Object[] args) {
        ...
        try {
            ...
            JasperClassFactory factory =
                    JasperClassFactory.getJasperClassFactory(visitorObj.getClass().getClassLoader());
