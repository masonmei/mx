...
public abstract class AbstractCrossProcessTracer extends AbstractExternalComponentTracer implements InboundHeaders {
    ...
    protected void doFinish(int opcode, Object returnValue) {
        ...
        getTransaction().getCrossProcessState().processInboundResponseHeaders(this, this, getHost(), uri, false);
    ...
    public String getHeader(String name) {
        return getHeaderValue(response, name);
    }
    ...
    public void setMetricNameFormat(MetricNameFormat nameFormat) {
        ...
        if ((nameFormat instanceof CrossProcessNameFormat)) {
            crossProcessFormat = ((CrossProcessNameFormat) nameFormat);
        }
    }
    ...
    protected void doRecordCrossProcessRollup(TransactionStats transactionStats) {
        if (crossProcessFormat != null) {
            String hostCrossProcessIdRollupMetricName = crossProcessFormat.getHostCrossProcessIdRollupMetricName();
