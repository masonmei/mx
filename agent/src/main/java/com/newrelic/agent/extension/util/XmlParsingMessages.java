...
class XmlParsingMessages {
    ...
    protected static final String NEG_EXT_VER =
            " The version number must be a double and must be greater than or equal to 0.\n";
    protected static final String NO_INST_TAG =
    ...
    protected static final String NO_CLASS_NAME =
            "A class name, interface name, or super class name needs to be specified for every point cut in the "
                    + "extension {0}";
    protected static final String NO_METHOD =
            "At least one method must be specified for each point cut in the extension {0}";
    protected static final String NO_METHOD_NAME =
            "A method name must be specified for each method in the extension {0}";
    protected static final String NO_METHOD_PARAMS =
            "An error occured when reading the XML method for method {0} in extension {1}";
