...
public class ConfigFileHelper {
    ...
    public static File findConfigFile() {
        ...
        if ((parentDir != null) && (Boolean.getBoolean(NEW_RELIC_DEBUG_PROPERTY))) {
    ...
    private static File findFromProperty() {
        ...
        if (filePath != null) {
            ...
            System.err.println(MessageFormat.format("The configuration file {0} specified with the {1} property does "
                                                            + "not exist", new Object[] {configFile.getAbsolutePath(),
    ...
    private static File findHomeDirectoryFromProperty() {
        ...
        if (filePath != null) {
            ...
            System.err.println(MessageFormat.format("The directory {0} specified with the {1} property does not exist",
                                                           new Object[] {homeDir.getAbsolutePath(),
                                                                                NEW_RELIC_HOME_DIRECTORY_PROPERTY}));
        }
        ...
        if (filePath != null) {
            ...
            System.err.println(MessageFormat
                                       .format("The directory {0} specified with the {1} environment variable does "
                                                       + "not exist", new Object[] {homeDir.getAbsolutePath(),
