...
@InterfaceMixin(originalClassName = {"org/apache/commons/dbcp/DelegatingConnection"})
public interface DelegatingConnection {
    Connection getInnermostDelegate();

    Connection getDelegate();

    @InterfaceMixin(originalClassName = {"org/apache/commons/dbcp/PoolingDataSource$PoolGuardConnectionWrapper"})
