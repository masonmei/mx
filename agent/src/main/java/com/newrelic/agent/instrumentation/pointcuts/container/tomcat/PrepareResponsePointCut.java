...
public class PrepareResponsePointCut extends com.newrelic.agent.instrumentation.PointCut implements
    ...
    private static final String COYOTE_ABSTRACT_HTTP11_PROCESSOR_CLASS =
    ...
    private static ClassMatcher createClassMatcher() {
        return ExactClassMatcher.or(new String[] {"org/apache/coyote/http11/AbstractHttp11Processor",
