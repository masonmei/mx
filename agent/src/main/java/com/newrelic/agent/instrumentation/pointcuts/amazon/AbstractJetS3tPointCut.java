...
public abstract class AbstractJetS3tPointCut extends TracerFactoryPointCut {
    ...
    protected static final String GOOGLE_STORAGE_SERVICE =
    ...
    protected AbstractJetS3tPointCut(Class<? extends TracerFactoryPointCut> tracerFactory,
                                     MethodMatcher[] methodMatchers) {
        super(tracerFactory, new ExactClassMatcher("org/jets3t/service/S3Service"),
                     OrMethodMatcher.getMethodMatcher(methodMatchers));
    }
