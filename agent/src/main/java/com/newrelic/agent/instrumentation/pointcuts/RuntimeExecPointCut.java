...
public class RuntimeExecPointCut extends TracerFactoryPointCut {
    public RuntimeExecPointCut(ClassTransformer classTransformer) {
        super(new PointCutConfiguration(RuntimeExecPointCut.class.getName(), null, false),
                     new ExactClassMatcher("java/lang/Runtime"), createExactMethodMatcher("exec",
                                                                                                 new String[] {"(Ljava/lang/String;[Ljava/lang/String;Ljava/io/File;)Ljava/lang/Process;",
