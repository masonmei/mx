...
public class ScalaCollectionJavaConversions {
    ...
    private static final MethodCache mapAsJavaMapCache = ServiceFactory.getCacheService()
                                                                 .getMethodCache("scala.collection.JavaConversions",
                                                                                        "mapAsJavaMap",
                                                                                        "(Lscala/collection/Map;)"
                                                                                                + "Ljava/util/Map;");

    private static final MethodCache seqAsJavaListCache = ServiceFactory.getCacheService()
                                                                  .getMethodCache("scala.collection.JavaConversions",
                                                                                         "seqAsJavaList",
    ...
    private static final SingleClassLoader javaConversions =
            ServiceFactory.getCacheService().getSingleClassLoader("scala.collection.JavaConversions");

    private static final SingleClassLoader scalaMap =
            ServiceFactory.getCacheService().getSingleClassLoader("scala.collection.Map");

    private static final SingleClassLoader scalaSeq =
            ServiceFactory.getCacheService().getSingleClassLoader("scala.collection.Seq");
