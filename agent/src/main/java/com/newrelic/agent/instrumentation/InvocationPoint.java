...
final class InvocationPoint implements InvocationHandler {
    ...
    public static InvocationHandler getStacklessInvocationHandler(ClassMethodSignature classMethodSignature,
        ...
        return new InvocationPoint.StacklessInvocationPoint(classMethodSignature, tracerFactory);
    }
    ...
    public static InvocationHandler getInvocationPoint(PointCutInvocationHandler invocationHandler,
        ...
        if (invocationHandler instanceof EntryInvocationHandler) {
            ...
            return ignoreApdex ? IgnoreApdexInvocationHandler.INVOCATION_HANDLER
                           : NoOpInvocationHandler.INVOCATION_HANDLER;
        }
    }
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        try {
            if (this.ignoreApdex) {
                ...
                if (t != null) {
                    Dispatcher dispatcher = t.getDispatcher();
                    if (dispatcher != null) {
            ...
            Agent.LOG.log(Level.FINEST, "Tracer invocation error", var7);
            return null;
        }
    }
