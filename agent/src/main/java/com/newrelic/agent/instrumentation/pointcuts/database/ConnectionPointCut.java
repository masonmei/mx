...
public class ConnectionPointCut extends TracerFactoryPointCut {
    public ConnectionPointCut(ClassTransformer classTransformer) {
        super(ConnectionPointCut.class, ExactClassMatcher
                                                .or(new String[]
                                                            {"com/newrelic/agent/deps/org/apache/commons/dbcp/PoolingDataSource$PoolGuardConnectionWrapper",
                                                                         "com/newrelic/agent/deps/org/apache/commons/dbcp/PoolableConnection",
                     ...
                     createExactMethodMatcher("close", new String[] {"()V"}));
    }
