...
public class AkkaTransactionHolderDispatcherPointCut extends TransactionHolderDispatcherPointCut {
    ...
    private static final String HANDLE_INVOKE_FAILURE_DESC =
            "(Lscala/collection/Iterable;Ljava/lang/Throwable;Ljava/lang/String;)V";
    ...
    private static ClassMatcher createClassMatcher() {
        return OrClassMatcher.getClassMatcher(new ClassMatcher[] {new ExactClassMatcher("akka/actor/ActorCell"),
    ...
    private static MethodMatcher createMethodMatcher() {
        return OrMethodMatcher.getMethodMatcher(new MethodMatcher[] {new ExactMethodMatcher("run", "()V"),
                                                                            new NameMethodMatcher("invoke"),
