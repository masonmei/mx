...
public class Utils
{
  ...
  private static final Set<String> JAXB_SUPERCLASSES = ImmutableSet.of("com.sun.xml.internal.bind.v2.runtime.reflect.Accessor", "com.sun.xml.bind.v2.runtime.reflect.Accessor", "com.sun.xml.internal.bind.v2.runtime.unmarshaller.Receiver");
    ...
    throws IOException, BenignClassReadException
  {
    ...
    if (resource == null)
    {
      ClassReader reader = ServiceFactory.getClassTransformerService().getContextManager().getClassWeaverService().getClassReader(theClass);
