...
public class SqlTraceServiceImpl extends AbstractService
  implements SqlTraceService, TransactionListener, HarvestListener
{
  ...
  private SqlTracerAggregator getOrCreateSqlTracerAggregator(String appName)
  {
    ...
    SqlTracerAggregator oldSqlTracerAggregator = (SqlTracerAggregator)this.sqlTracerAggregators.putIfAbsent(appName, sqlTracerAggregator);
