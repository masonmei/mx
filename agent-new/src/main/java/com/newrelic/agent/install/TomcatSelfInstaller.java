...
public class TomcatSelfInstaller extends SelfInstaller
{
  ...
  {
    String unixSwitch = "NR_JAR=" + this.rootDir + "/newrelic/newrelic.jar; export NR_JAR" + lineSep + "CATALINA_OPTS=\"\\$CATALINA_OPTS -javaagent:\\$NR_JAR\"; export CATALINA_OPTS" + lineSep;

    String winSwitch = "set CATALINA_OPTS=%CATALINA_OPTS% -javaagent:\"" + this.rootDir.replaceAll("\\\\", "/") + "/newrelic/newrelic.jar\"" + lineSep;
