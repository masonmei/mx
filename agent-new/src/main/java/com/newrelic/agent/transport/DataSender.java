...
{
  public abstract Map<String, Object> connect(Map<String, Object> paramMap)
    throws Exception;

  public abstract List<List<?>> getAgentCommands()
    throws Exception;

  public abstract void queuePingCommand()
    throws Exception;

  public abstract void sendCommandResults(Map<Long, Object> paramMap)
    throws Exception;

  public abstract void sendErrorData(List<TracedError> paramList)
    throws Exception;
  ...
  public abstract void shutdown(long paramLong)
    throws Exception;

  public abstract List<?> getXRayParameters(Collection<Long> paramCollection)
    throws Exception;
}