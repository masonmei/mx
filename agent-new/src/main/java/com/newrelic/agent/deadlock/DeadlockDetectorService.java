...
public class DeadlockDetectorService extends AbstractService
{
  ...
  public DeadlockDetectorService()
  {
    ...
    ThreadFactory threadFactory = this.isEnabled ? new DefaultThreadFactory("New Relic Deadlock Detector", true) : null;
    ...
    Runnable runnable = new Runnable()
    {
      public void run()
      {
        try {
          ...
          String msg = MessageFormat.format("Failed to detect deadlocked threads: {0}", new Object[] { t.toString() });
