...
public abstract class TracedError
  implements Comparable<TracedError>, JSONStreamAware
{
  ...
  {
    JSONArray.writeJSONString(Arrays.asList(new Object[] { Long.valueOf(getTimestamp()), getPath(), getMessage(), getExceptionClass(), getAttributes() }), writer);
  }
