...
public class ThrowableError extends TracedError
{
  ...
  public ThrowableError(String appName, String frontendMetricName, Throwable error, String requestPath, long timestamp, Map<String, Map<String, String>> prefixedParams, Map<String, Object> userParams, Map<String, Object> agentParams, Map<String, String> errorParams, Map<String, Object> intrinsics)
  {
