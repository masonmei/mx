...
public class JettyJmxMetrics extends JmxFrameworkValues
{
  ...
  private static final JmxMetric CURRENT_ACTIVE_COUNT = JmxMetric.create(new String[] { "threads", "idleThreads" }, "Active", JmxAction.SUBTRACT_ALL_FROM_FIRST, JmxType.SIMPLE);
  ...
  static
  {
    METRICS.add(new BaseJmxValue("org.eclipse.jetty.util.thread:type=queuedthreadpool,id=*", "JmxBuiltIn/ThreadPool/{id}/", new JmxMetric[] { CURRENT_IDLE_COUNT, CURRENT_ACTIVE_COUNT, CURRENT_MAX_COUNT }));
  }
}