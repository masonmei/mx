...
public class WebSphereJmxValues extends JmxFrameworkValues
{
  ...
  public static String PREFIX = "WebSphere-8";
  ...
  static
  {
    ...
    METRICS.add(new BaseJmxValue("WebSphere:j2eeType=JTAResource,type=TransactionService,name=*,process=*,platform=*,node=*,*", "JmxBuiltIn/JTA/{type}/", new JmxMetric[] { JtaJmxMetricGenerator.COMMIT.createMetric(new String[] { "stats.CommittedCount" }), JtaJmxMetricGenerator.ROLLBACK.createMetric(new String[] { "stats.RolledbackCount" }), JtaJmxMetricGenerator.TIMEOUT.createMetric(new String[] { "stats.GlobalTimeoutCount" }) }));
