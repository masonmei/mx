...
public class Glassfish2JmxValues extends JmxFrameworkValues {
    ...
    static {
        METRICS.add(new BaseJmxValue("com.sun.appserv:name=*,type=thread-pool,category=monitor,server=*",
                                            "JmxBuiltIn/ThreadPool/{name}/",
                                            new JmxMetric[] {ServerJmxMetricGenerator.ACTIVE_THREAD_POOL_COUNT
                                                                     .createMetric("numberofbusythreads-count"),
                                                                    ServerJmxMetricGenerator.IDLE_THREAD_POOL_COUNT
                                                                            .createMetric
                                                                                     ("numberofavailablethreads-count")}));

        METRICS.add(new BaseJmxValue("com.sun.appserv:type=Manager,path=*,host=server", "JmxBuiltIn/Session/{path}/",
                                            new JmxMetric[] {ServerJmxMetricGenerator.SESSION_ACTIVE_COUNT
                                                                     .createMetric("activeSessions"),
                                                                    ServerJmxMetricGenerator.SESSION_EXPIRED_COUNT
                                                                            .createMetric("expiredSessions"),
        ...
        METRICS.add(new BaseJmxValue("com.sun.appserv:type=transaction-service,category=monitor,server=*",
                                            ...
                                            new JmxMetric[] {ServerJmxMetricGenerator.TRANS_ACTIVE_COUNT
                                                                     .createMetric("activecount-count"),
                                                                    ServerJmxMetricGenerator.TRANS_COMMITED_COUNT
                                                                            .createMetric("committedcount-count"),
                                                                    ServerJmxMetricGenerator.TRANS_ROLLED_BACK_COUNT
                                                                            .createMetric("rolledbackcount-count")}));
    }
