...
class LogbackLogger implements IAgentLogger {
    ...
    public boolean isFineEnabled() {
        return (this.logger.isDebugEnabled()) && (FineFilter.getFineFilter()
                                                          .isEnabledFor(java.util.logging.Level.FINE));
    }

    public boolean isFinerEnabled() {
        return (this.logger.isDebugEnabled()) && (FineFilter.getFineFilter()
                                                          .isEnabledFor(java.util.logging.Level.FINER));
    }
    ...
    public void log(java.util.logging.Level pLevel, final String pMessage, final Throwable pThrowable) {
        if (isLoggable(pLevel)) {
            ...
            AccessController.doPrivileged(new PrivilegedAction() {
                public Void run() {
                    LogbackLogger.this.logger.log(level.getMarker(), Logger.FQCN, level.getLogbackLevel()
                                                                                          .toLocationAwareLoggerInteger(level.getLogbackLevel()),
    ...
    public void log(java.util.logging.Level pLevel, String pMessage) {
        LogbackLevel level = LogbackLevel.getLevel(pLevel);
        this.logger.log(level.getMarker(), Logger.FQCN,
