...
enum LogbackLevel {
    ...
    FINE("fine", com.newrelic.deps.ch.qos.logback.classic.Level.DEBUG, java.util.logging.Level.FINE,
                LogbackMarkers.FINE_MARKER),

    FINER("finer", com.newrelic.deps.ch.qos.logback.classic.Level.DEBUG, java.util.logging.Level.FINER,
                 LogbackMarkers.FINER_MARKER),

    FINEST("finest", com.newrelic.deps.ch.qos.logback.classic.Level.TRACE, java.util.logging.Level.FINEST,
                  LogbackMarkers.FINEST_MARKER),
    ...
    private LogbackLevel(String pName, com.newrelic.deps.ch.qos.logback.classic.Level pLogbackLevel,
                         java.util.logging.Level pJavaLevel, Marker pMarker) {
        this.name = pName;
