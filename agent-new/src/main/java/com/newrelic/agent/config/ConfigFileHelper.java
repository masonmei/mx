...
public class ConfigFileHelper
{
  ...
  public static File findConfigFile()
  {
    ...
    if ((parentDir != null) && 
      (Boolean.getBoolean("newrelic.debug"))) {
  ...
  private static File findFromProperty()
  {
    ...
    if (filePath != null) {
      ...
      System.err.println(MessageFormat.format("The configuration file {0} specified with the {1} property does not exist", new Object[] { configFile.getAbsolutePath(), "newrelic.config.file" }));
    }
  ...
  private static File findHomeDirectoryFromProperty()
  {
    ...
    if (filePath != null) {
      ...
      System.err.println(MessageFormat.format("The directory {0} specified with the {1} property does not exist", new Object[] { homeDir.getAbsolutePath(), "newrelic.home" }));
    }
  ...
  private static File findHomeDirectoryFromEnvironmentVariable()
  {
    ...
    if (filePath != null) {
      ...
      System.err.println(MessageFormat.format("The directory {0} specified with the {1} environment variable does not exist", new Object[] { homeDir.getAbsolutePath(), "NEWRELIC_HOME" }));
    }
  ...
  private static File findConfigFile(File parentDirectory)
  {
    for (String searchDir : SEARCH_DIRECTORIES) {
      ...
      if (Boolean.getBoolean("newrelic.debug")) {
        System.err.println(MessageFormat.format("Searching for NewRelic configuration in directory {0}", new Object[] { configDir }));
      }
