...
public class LabelsConfigImpl
  implements LabelsConfig, JSONStreamAware
{
  ...
  public void writeJSONString(Writer out)
    throws IOException
  {
    List jsonLabels = new ArrayList(this.labels.size());
    for (Entry entry : this.labels.entrySet()) {
