...
public class InstrumentationProxy extends InstrumentationWrapper
{
  ...
  protected InstrumentationProxy(Instrumentation instrumentation, boolean enableBootstrapClassInstrumentationDefault)
  {
    ...
    this.bootstrapClassIntrumentationEnabled = ((Boolean)config.getProperty("enable_bootstrap_class_instrumentation", Boolean.valueOf(enableBootstrapClassInstrumentationDefault))).booleanValue();
  }
