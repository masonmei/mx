...
public class CrossProcessNameFormat implements MetricNameFormat {
    ...
    public String toString() {
        ...
        sb.append("host:").append(this.hostName).append(" crossProcessId:").append(this.crossProcessId)
                .append(" transactionName:").append(this.transactionName).append(" uri:").append(this.uri)
    ...
    public String getMetricName() {
        return Strings.join('/', new String[] {"ExternalTransaction", this.hostName, this.crossProcessId,
