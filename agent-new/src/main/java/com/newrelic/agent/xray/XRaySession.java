...
public class XRaySession {
    ...
    public boolean sessionHasExpired() {
        return (this.collectedTraceCount.get() >= this.requestedTraceCount) || (System.nanoTime()
                                                                                        > this.sessionEndTimeInNanos);
    }
    ...
    public String toString() {
        return String.format("XRaySession [xRayId=%s, applicationName=%s, runProfiler=%s, keyTransactionName=%s, "
                                     ...
                                     + "derived end time=%s]",
                                    new Object[] {this.xRayId, this.applicationName, Boolean.valueOf(this.runProfiler),
                                                         this.keyTransactionName, Long.valueOf(this.samplePeriodMillis),
                                                         this.xRaySessionName, Long.valueOf(this.durationMilliseconds),
                                                         Long.valueOf(this.requestedTraceCount),
                                                         Long.valueOf(this.sessionEndTimeInNanos),
                                                         this.collectedTraceCount, this.endTimeForDisplay});
    }
}