...
class XmlExtension extends Extension
{
  ...
  public XmlExtension(ClassLoader classloader, String name, com.newrelic.agent.extension.beans.Extension ext, boolean custom)
  {
  ...
  {
    if (isEnabled()) {
      return ExtensionConversionUtility.convertToEnabledPointCuts(Arrays.asList(new com.newrelic.agent.extension.beans.Extension[] { this.extension }), isCustom(), InstrumentationType.LocalCustomXml);
    }
