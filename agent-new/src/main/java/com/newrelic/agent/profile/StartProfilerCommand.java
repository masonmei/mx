...
public class StartProfilerCommand extends AbstractCommand
{
  ...
  private ProfilerParameters createProfilerParameters(Map<?, ?> arguments) throws CommandException {
    ...
    if (samplePeriod > duration) {
      String msg = MessageFormat.format("{0} > {1} in start_profiler command: {2} > {3}", new Object[] { "sample_period", "duration", Double.valueOf(samplePeriod), Double.valueOf(duration) });
    ...
    if (arguments.size() > 0) {
      String msg = MessageFormat.format("Unexpected arguments in start_profiler command: {0}", new Object[] { arguments.keySet().toString() });

      Agent.LOG.warning(msg);
    }

    return new ProfilerParameters(Long.valueOf(profileId), samplePeriodInMillis, durationInMillis, onlyRunnableThreads, onlyRequestThreads, profileAgentCode, null, null, null);
  }
  ...
  private long getProfileId(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "profile_id", profileId });
    throw new CommandException(msg);
  }
  ...
  private double getSamplePeriod(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "sample_period", samplePeriod });
    throw new CommandException(msg);
  }
  ...
  private double getDuration(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "duration", duration });
    throw new CommandException(msg);
  }
  ...
  private boolean getOnlyRunnableThreads(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "only_runnable_threads", onlyRunnableThreads });
  ...
  private boolean getOnlyRequestThreads(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "only_request_threads", onlyRequestThreads });
  ...
  private boolean getProfileAgentCode(Map<?, ?> arguments) throws CommandException
  {
    ...
    String msg = MessageFormat.format("Invalid {0} in start_profiler command: {1}", new Object[] { "profile_agent_code", profileAgentCode });
