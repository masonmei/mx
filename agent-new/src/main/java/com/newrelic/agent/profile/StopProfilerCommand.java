...
public class StopProfilerCommand extends AbstractCommand
{
    ...
    throws CommandException
  {
    ...
    Object report = arguments.get("report_data"); Object profileId = arguments.get("profile_id");
    ...
    this.profilerControl.stopProfiler(Long.valueOf(((Number)profileId).longValue()), ((Boolean)report).booleanValue());
