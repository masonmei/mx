...
public class AkkaTransactionHolderInitPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  {
    return OrClassMatcher.getClassMatcher(new ClassMatcher[] { new ExactClassMatcher("akka/dispatch/Envelope"), new ExactClassMatcher("akka/dispatch/AbstractPromise"), new ExactClassMatcher("akka/dispatch/Future$$anon$4") });
  }
