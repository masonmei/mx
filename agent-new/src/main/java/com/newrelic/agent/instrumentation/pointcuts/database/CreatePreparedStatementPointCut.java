...
public class CreatePreparedStatementPointCut extends com.newrelic.agent.instrumentation.PointCut
{
  ...
  static final MethodMatcher METHOD_MATCHER = OrMethodMatcher.getMethodMatcher(new MethodMatcher[] { new ExactMethodMatcher("prepareStatement", new String[] { "(Ljava/lang/String;)Ljava/sql/PreparedStatement;", "(Ljava/lang/String;III)Ljava/sql/PreparedStatement;", "(Ljava/lang/String;II)Ljava/sql/PreparedStatement;", "(Ljava/lang/String;I)Ljava/sql/PreparedStatement;", "(Ljava/lang/String;[I)Ljava/sql/PreparedStatement;", "(Ljava/lang/String;[Ljava/lang/String;)Ljava/sql/PreparedStatement;" }), new ExactMethodMatcher("prepareCall", new String[] { "(Ljava/lang/String;)Ljava/sql/CallableStatement;", "(Ljava/lang/String;II)Ljava/sql/CallableStatement;", "(Ljava/lang/String;III)Ljava/sql/CallableStatement;" }) });
  ...
  private CreatePreparedStatementPointCut(AgentConfig config) {
    super(new PointCutConfiguration("jdbc_prepare_statement", null, isEnabledByDefault()), getClassMatcher(config), METHOD_MATCHER);
