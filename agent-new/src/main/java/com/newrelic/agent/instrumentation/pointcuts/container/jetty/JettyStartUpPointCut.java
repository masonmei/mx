...
public class JettyStartUpPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  public JettyStartUpPointCut(ClassTransformer classTransformer) {
    super(new PointCutConfiguration(JettyStartUpPointCut.class.getName(), null, true), createClassMatcher(), createExactMethodMatcher("start", new String[] { "(Ljava/util/List;)V" }));
  }
