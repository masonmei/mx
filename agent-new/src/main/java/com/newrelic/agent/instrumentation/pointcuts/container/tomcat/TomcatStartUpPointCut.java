...
public class TomcatStartUpPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  public TomcatStartUpPointCut(ClassTransformer classTransformer) {
    super(new PointCutConfiguration(TomcatStartUpPointCut.class.getName(), "tomcat", true), createClassMatcher(), OrMethodMatcher.getMethodMatcher(new MethodMatcher[] { createExactMethodMatcher("start", new String[] { "()V" }), createExactMethodMatcher("getServer", new String[] { "()Lorg/apache/catalina/Server;" }) }));
  }
