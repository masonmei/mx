...
public class ResinStartupPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  public ResinStartupPointCut(ClassTransformer classTransformer) {
    super(new PointCutConfiguration(ResinStartupPointCut.class.getName(), "resin_instrumentation", true), new ExactClassMatcher("com.caucho.server.resin/Resin"), createExactMethodMatcher("start", new String[] { "()V" }));
  }
