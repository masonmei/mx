...
public class HttpMethodBasePointCut extends HttpCommonsPointCut {
    ...
    public HttpMethodBasePointCut(ClassTransformer classTransformer) {
        ...
        this.getHostMethodCache = ServiceFactory.getCacheService()
                                          .getMethodCache
                                                   ("com/newrelic/agent/deps/org/apache/commons/httpclient/HttpConnection",
                                                                 "getHost", "()V");

        this.getPortMethodCache = ServiceFactory.getCacheService()
                                          .getMethodCache
                                                   ("com/newrelic/agent/deps/org/apache/commons/httpclient/HttpConnection",
                                                                 "getPort", "()I");

        this.getProtocolMethodCache = ServiceFactory.getCacheService()
                                              .getMethodCache
                                                       ("com/newrelic/agent/deps/org/apache/commons/httpclient/HttpConnection",
                                                                     "getProtocol",
