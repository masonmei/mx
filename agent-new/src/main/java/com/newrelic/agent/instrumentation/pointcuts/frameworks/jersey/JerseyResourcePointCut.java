...
public class JerseyResourcePointCut extends TracerFactoryPointCut
{
  ...
  {
    super(new PointCutConfiguration(JerseyResourcePointCut.class), ExactClassMatcher.or(new String[] { "com/sun/jersey/server/impl/model/method/dispatch/ResourceJavaMethodDispatcher", "com/sun/jersey/impl/model/method/dispatch/ResourceJavaMethodDispatcher" }), createExactMethodMatcher("dispatch", new String[] { "(Ljava/lang/Object;Lcom/sun/jersey/api/core/HttpContext;)V" }));
  }
  ...
  public Tracer doGetTracer(Transaction transaction, ClassMethodSignature sig, Object dispatcher, Object[] args)
  {
    try
    {
      ...
      ClassMethodMetricNameFormat metricNameFormatter = new ClassMethodMetricNameFormat(new ClassMethodSignature(args[0].getClass().getName(), methodName, ""), args[0]);
