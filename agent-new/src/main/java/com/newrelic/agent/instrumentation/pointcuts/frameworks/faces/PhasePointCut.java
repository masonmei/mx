...
public class PhasePointCut extends TracerFactoryPointCut
{
  ...
  {
    super(new PointCutConfiguration(PhasePointCut.class), new ExactClassMatcher("com/sun/faces/lifecycle/Phase"), createExactMethodMatcher("doPhase", new String[] { "(Ljavax/faces/context/FacesContext;Ljavax/faces/lifecycle/Lifecycle;Ljava/util/ListIterator;)V" }));
  }
