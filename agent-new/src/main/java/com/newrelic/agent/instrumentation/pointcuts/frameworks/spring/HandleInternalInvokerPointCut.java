...
public class HandleInternalInvokerPointCut extends MethodInvokerPointCut
{
  ...
  {
    super(new InterfaceMatcher("org/springframework/web/servlet/HandlerAdapter"), OrMethodMatcher.getMethodMatcher(new MethodMatcher[] { createExactMethodMatcher("invokeHandleMethod", new String[] { "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/springframework/web/method/HandlerMethod;)Lorg/springframework/web/servlet/ModelAndView;" }), createExactMethodMatcher("invokeHandlerMethod", new String[] { "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;Lorg/springframework/web/method/HandlerMethod;)Lorg/springframework/web/servlet/ModelAndView;" }) }));
  }
