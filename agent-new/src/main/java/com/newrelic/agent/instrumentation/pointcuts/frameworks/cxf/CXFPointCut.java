...
public class CXFPointCut extends TracerFactoryPointCut
{
  ...
  {
    super(CXFPointCut.class, new ExactClassMatcher("org/apache/cxf/transport/servlet/ServletDestination"), createExactMethodMatcher("invoke", new String[] { "(Ljavax/servlet/ServletConfig;Ljavax/servlet/ServletContext;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V" }));
  }
  ...
  public Tracer doGetTracer(Transaction transaction, ClassMethodSignature sig, Object servletDest, Object[] args)
  {
    try
    {
      Object endpointInfo = servletDest.getClass().getMethod("getEndpointInfo", new Class[0]).invoke(servletDest, new Object[0]);
