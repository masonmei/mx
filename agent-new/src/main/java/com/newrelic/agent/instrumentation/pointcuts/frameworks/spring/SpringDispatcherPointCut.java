...
public class SpringDispatcherPointCut extends TracerFactoryPointCut
{
  ...
  {
    super(SpringDispatcherPointCut.class, new ExactClassMatcher("org/springframework/web/servlet/DispatcherServlet"), createMethodMatcher(new MethodMatcher[] { new ExactMethodMatcher("render", "(Lorg/springframework/web/servlet/ModelAndView;Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V"), new ExactMethodMatcher("doDispatch", "(Ljavax/servlet/http/HttpServletRequest;Ljavax/servlet/http/HttpServletResponse;)V") }));
  ...
  private void setTransactionName(Transaction transaction, String viewName)
  {
    ...
    if ((Agent.LOG.isLoggable(Level.FINER)) && 
      ...
      String msg = MessageFormat.format("Setting transaction name to \"{0}\" using Spring view", new Object[] { viewName });
      Agent.LOG.finer(msg);
    }
