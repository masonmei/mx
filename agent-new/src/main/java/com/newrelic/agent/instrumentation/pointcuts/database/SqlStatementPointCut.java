...
public class SqlStatementPointCut extends TracerFactoryPointCut
{
  ...
  private static final MethodMatcher METHOD_MATCHER = OrMethodMatcher.getMethodMatcher(new MethodMatcher[] { new ExactMethodMatcher("execute", new String[] { "(Ljava/lang/String;)Z", "(Ljava/lang/String;I)Z", "(Ljava/lang/String;[I)Z", "(Ljava/lang/String;[Ljava/lang/String;)Z" }), new ExactMethodMatcher("executeUpdate", new String[] { "(Ljava/lang/String;)I", "(Ljava/lang/String;I)I", "(Ljava/lang/String;[I)I", "(Ljava/lang/String;[Ljava/lang/String;)I" }), new ExactMethodMatcher("executeQuery", "(Ljava/lang/String;)Ljava/sql/ResultSet;") });
    ...
    if (args.length > 0) {
      ...
      if ((parent instanceof SqlStatementTracer)) {
        if (Agent.LOG.isLoggable(Level.FINEST)) {
          String msg = MessageFormat.format("Skipping sql statement because last tracer is a SqlStatementTracer: {0}", new Object[] { statement.getClass().getName() });
      ...
      if (Agent.LOG.isLoggable(Level.FINEST)) {
        String msg = MessageFormat.format("Created SqlStatementTracer for: {0}", new Object[] { statement.getClass().getName() });
        Agent.LOG.finest(msg);
      }
