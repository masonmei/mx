...
public class InstrumentationVerifier
{
  ...
  public boolean verify(String instrumentationJar, List<String> userJars)
    throws Exception
  {
    ...
    boolean result = verifier.verify(instrumentationPackage.getClassAppender(), loader, instrumentationPackage.getClassBytes(), instrumentationPackage.newClassLoadOrder);
  ...
  private InstrumentationPackage getInstrumentationPackage(String instrumentationJar) throws Exception {
    ...
    InstrumentationMetadata instrumentationMetadata = new InstrumentationMetadata(jarStream, instrumentationJarUrl.toString());

    return new InstrumentationPackage(new MockInstrumentation(), this.logger, instrumentationMetadata, jarStream);
  }

  private ClassLoader createClassloaderForVerification(List<String> jars)
