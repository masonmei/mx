...
public class TaggingInvokerPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  private void setTransactionName(Transaction tx, String controllerAction) {
    ...
    if ((Agent.LOG.isLoggable(Level.FINER)) && 
      ...
      String msg = MessageFormat.format("Setting transaction name to \"{0}\" using Play 2.3 controller action", new Object[] { controllerAction });
