...
public class AsyncHttpClientRequestPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  public void handleInvocation(ClassMethodSignature sig, Object object, Object[] args)
  {
    ...
    {
      Object tracerInfo = new AsyncHttpClientTracerInfo(sig, url == null ? "URL_PARSE_ERROR" : url.getHost(), request.getUrl(), request.getMethod());

      tracerHolder._nr_setTracer(tracerInfo); }  } 
  @InterfaceMixin(originalClassName={"scala/runtime/ObjectRef"})
  public static abstract interface ObjectRef { public static final String CLASS = "scala/runtime/ObjectRef";
  ...
  public static abstract interface AsyncHandler { public static final String SCALA_CLASS = "play.api.libs.ws.WS$WSRequest$$anon$1";
  ...
  public static abstract interface JavaAsyncHandler { public static final String CLASS = "play.libs.WS$WSRequest$1";
  ...
  public static abstract interface Request { public static final String INTERFACE = "com/ning/http/client/Request";

    public abstract String getMethod();

    public abstract String getUrl(); } 
  public static final class AsyncHttpClientTracerInfo { private final long startTime;
    private final ClassMethodSignature sig;
    private final String host;
    private final String uri;
    private final String methodName;

    public AsyncHttpClientTracerInfo(ClassMethodSignature sig, String host, String uri, String methodName) { this.startTime = System.nanoTime();
      this.sig = sig;
      this.host = host;
      this.uri = uri;
