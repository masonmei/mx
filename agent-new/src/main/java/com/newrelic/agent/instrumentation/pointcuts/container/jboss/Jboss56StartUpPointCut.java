...
public class Jboss56StartUpPointCut extends com.newrelic.agent.instrumentation.PointCut
  implements EntryInvocationHandler
{
  ...
  public Jboss56StartUpPointCut(ClassTransformer classTransformer) {
    super(new PointCutConfiguration(Jboss56StartUpPointCut.class.getName(), "jboss_instrumentation", true), createClassMatcher(), createExactMethodMatcher("boot", new String[] { "([Ljava/lang/String;)V" }));
  }
