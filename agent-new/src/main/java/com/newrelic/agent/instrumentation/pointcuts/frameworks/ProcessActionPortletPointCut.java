...
public class ProcessActionPortletPointCut extends AbstractPortletPointCut
{
  ...
  {
    super(ProcessActionPortletPointCut.class, createExactMethodMatcher("processAction", new String[] { "(Ljavax/portlet/ActionRequest;Ljavax/portlet/ActionResponse;)V" }));
  }
