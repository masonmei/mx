...
public class ConnectionClassTransformer extends AbstractImplementationClassTransformer
{
  ...
  {
    super(classTransformer, true, ConnectionExtension.class, ExactClassMatcher.or(new String[] { "com/mysql/jdbc/ConnectionImpl", "oracle/jdbc/driver/PhysicalConnection", "oracle/jdbc/OracleConnectionWrapper", "org/apache/derby/impl/jdbc/EmbedConnection" }), NoMatchMatcher.MATCHER, "java/sql/Connection");
  }
