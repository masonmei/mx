...
public class ClearPreparedStatementParametersPointCut extends com.newrelic.agent.instrumentation.PointCut implements
    ...
    public ClearPreparedStatementParametersPointCut(ClassTransformer classTransformer) {
        super(new PointCutConfiguration("jdbc_parameterized_prepared_statement", null,
                     ...
                     ParameterizedPreparedStatementPointCut.createClassMatcher(), METHOD_MATCHER);
    }
