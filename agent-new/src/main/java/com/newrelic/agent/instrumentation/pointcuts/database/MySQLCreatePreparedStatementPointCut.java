...
public class MySQLCreatePreparedStatementPointCut extends com.newrelic.agent.instrumentation.PointCut {
    ...
    private static final MethodMatcher METHOD_MATCHER = OrMethodMatcher
                                                                .getMethodMatcher(new MethodMatcher[] {new ExactMethodMatcher("clientPrepareStatement",
                                                                                                              ...
                                                                                                              new ExactMethodMatcher("serverPrepareStatement",
                                                                                                                                            new String[] {"(Ljava/lang/String;)Ljava/sql/PreparedStatement;",
                                                                                                                                                                 "(Ljava/lang/String;III)Ljava/sql/PreparedStatement;",
                                                                                                                                                                 "(Ljava/lang/String;II)Ljava/sql/PreparedStatement;",
                                                                                                                                                                 "(Ljava/lang/String;I)Ljava/sql/PreparedStatement;",
                                                                                                                                                                 "(Ljava/lang/String;[I)Ljava/sql/PreparedStatement;",
                                                                                                                                                                 "(Ljava/lang/String;[Ljava/lang/String;)Ljava/sql/PreparedStatement;"}),
                                                                                                              CreatePreparedStatementPointCut.METHOD_MATCHER});
    ...
    private MySQLCreatePreparedStatementPointCut(AgentConfig config) {
        super(new PointCutConfiguration("jdbc_prepare_statement", null, true),
                     new ExactClassMatcher("com/mysql/jdbc/ConnectionImpl"), METHOD_MATCHER);
