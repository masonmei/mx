  ...
  implements StartableClassFileTransformer
{
  ...
  protected abstract ClassVisitor getClassVisitor(ClassReader paramClassReader, ClassWriter paramClassWriter, String paramString, ClassLoader paramClassLoader);

  protected abstract boolean matches(ClassLoader paramClassLoader, String paramString, Class<?> paramClass, ProtectionDomain paramProtectionDomain, byte[] paramArrayOfByte);
}