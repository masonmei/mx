...
public class AgentWrapper implements InvocationHandler {
        ...
        try {
            ...
            if ((proxy instanceof Integer)) {
                PointCutInvocationHandler invocationHandler =
                        this.tracerService.getInvocationHandler(((Integer) proxy).intValue());
    ...
    private Object createInvocationHandler(Object proxy, Object[] args) {
        ...
        return this.classTransformer.evaluate((Class) proxy, this.tracerService, args[0], args[1], args[2],
