...
class ReflectionHelper
{
  ...
  public ReflectionHelper()
  {
    ...
    for (java.lang.reflect.Method m : ClassReflection.class.getMethods()) {
      com.newrelic.deps.org.objectweb.asm.commons.Method staticMethod = com.newrelic.deps.org.objectweb.asm.commons.Method.getMethod(m);
      ...
      if ((m.getDeclaringClass().equals(ClassReflection.class)) && (staticMethod.getArgumentTypes().length > 0))
      {
        ...
        try
        {
          ...
          com.newrelic.deps.org.objectweb.asm.commons.Method targetMethod = new com.newrelic.deps.org.objectweb.asm.commons.Method(m.getName(), staticMethod.getReturnType(), argumentTypes);
  ...
  public boolean process(String owner, String name, String desc, GeneratorAdapter generatorAdapter)
  {
    ...
    if (classReflector != null) {
      com.newrelic.deps.org.objectweb.asm.commons.Method method = (com.newrelic.deps.org.objectweb.asm.commons.Method)classReflector.methods.get(new com.newrelic.deps.org.objectweb.asm.commons.Method(name, desc));
      if (method != null)
      {
  ...
  {
    private final Map<com.newrelic.deps.org.objectweb.asm.commons.Method, com.newrelic.deps.org.objectweb.asm.commons.Method> methods = Maps.newHashMap();
  }
}