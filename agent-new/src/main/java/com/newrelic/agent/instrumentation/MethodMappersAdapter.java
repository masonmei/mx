...
public class MethodMappersAdapter extends ClassVisitor {
    ...
    private MethodMappersAdapter(ClassVisitor cv,
                                 Map<com.newrelic.deps.org.objectweb.asm.commons.Method, java.lang.reflect.Method>
                                         methods,
    ...
    protected static Map<com.newrelic.deps.org.objectweb.asm.commons.Method, java.lang.reflect.Method>
    getMethodMappers(Class<?> type) {
        ...
        for (java.lang.reflect.Method method : type.getDeclaredMethods()) {
            ...
            if (method.getName().equals(annotation.originalMethodName())) {
                ...
                methods.put(new com.newrelic.deps.org.objectweb.asm.commons.Method(originalMethodName,
                                                                                          orginalDescriptor), method);
            }
        }
        return methods;
    }
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        com.newrelic.deps.org.objectweb.asm.commons.Method originalMethod =
