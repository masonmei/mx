...
abstract class AbstractSolrPointCut extends TracerFactoryPointCut
{
  ...
  protected AbstractSolrPointCut(Class<? extends AbstractSolrPointCut> pointCutClass, ClassMatcher classMatcher, MethodMatcher methodMatcher)
  {
    super(new PointCutConfiguration(pointCutClass.getName(), "solr", true), classMatcher, methodMatcher);
  }

  protected AbstractSolrPointCut(PointCutConfiguration config, ClassMatcher classMatcher, MethodMatcher methodMatcher)
  {
