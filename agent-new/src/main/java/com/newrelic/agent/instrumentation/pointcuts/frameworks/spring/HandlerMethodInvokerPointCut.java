...
public class HandlerMethodInvokerPointCut extends MethodInvokerPointCut {
    ...
    public HandlerMethodInvokerPointCut(ClassTransformer classTransformer) {
        super(new ExactClassMatcher("org/springframework/web/bind/annotation/support/HandlerMethodInvoker"),
                     OrMethodMatcher.getMethodMatcher(new MethodMatcher[] {createExactMethodMatcher("doInvokeMethod",
                                                                                                           new String[] {"(Ljava/lang/reflect/Method;Ljava/lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;"}),
    ...
    public Tracer doGetTracer(final Transaction transaction, ClassMethodSignature sig, Object invoker, Object[] args) {
        ...
        return new DefaultTracer(transaction, sig, invoker,
                                        new SimpleMetricNameFormat("Spring/Java/" + controller.getName() + '/'
                                                                           + methodName)) {
