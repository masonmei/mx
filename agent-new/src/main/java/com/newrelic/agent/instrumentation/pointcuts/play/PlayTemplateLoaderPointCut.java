...
public class PlayTemplateLoaderPointCut extends TracerFactoryPointCut
{
  ...
  private void setTransactionName(Transaction tx, String templatePath) {
    ...
    if ((Agent.LOG.isLoggable(Level.FINER)) && 
      (policy.canSetTransactionName(tx, TransactionNamePriority.FRAMEWORK_HIGH))) {
      String msg = MessageFormat.format("Setting transaction name to \"{0}\" using Play template", new Object[] { templatePath });
