  ...
  implements StartableClassFileTransformer
{
  ...
  protected abstract ClassVisitor createClassVisitor(ClassReader paramClassReader, ClassWriter paramClassWriter, String paramString, ClassLoader paramClassLoader);
