...
public class TransactionHolderDispatcherPointCut extends TracerFactoryPointCut
{
  ...
  public TransactionHolderDispatcherPointCut(PointCutConfiguration config, ClassMatcher classMatcher, MethodMatcher methodMatcher)
  {
  ...
  {
    return OrClassMatcher.getClassMatcher(new ClassMatcher[] { new ExactClassMatcher("scala/concurrent/impl/Future$PromiseCompletingRunnable"), new ExactClassMatcher("scala/concurrent/impl/CallbackRunnable") });
  }
