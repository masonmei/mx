...
public class ReflectionStyleClassMethodAdapter extends AbstractTracingMethodAdapter
{
  ...
  public ReflectionStyleClassMethodAdapter(GenericClassAdapter genericClassAdapter, MethodVisitor mv, int access, Method method, int tracerFactoryId)
  {
  ...
  protected void loadGetTracerArguments()
  {
    ...
    this.methodBuilder.loadArray(Object.class, new Object[] { this.genericClassAdapter.className, this.methodName, this.methodDesc, MethodBuilder.LOAD_THIS, MethodBuilder.LOAD_ARG_ARRAY });
  }
}