  ...
  implements IBrowserConfig
{
  ...
  private BrowserConfig(String appName, Map<String, Object> props)
    throws Exception
  {
    super(props);
  ...
  private void logVersion(String appName) {
    ...
    if (version != null)
      Agent.LOG.log(Level.INFO, MessageFormat.format("Using RUM version {0} for application \"{1}\"", new Object[] { version, appName }));
  }

  private String initBrowserHeader()
    throws Exception
  {
