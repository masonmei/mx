...
public final class ParsedDatabaseStatement implements MetricNameFormat {
    ...
    public ParsedDatabaseStatement(DatabaseVendor dbVendor, String model, String operation, boolean generateMetric) {
        ...
        this.operationRollupMetricName = MessageFormat.format("Datastore/operation/{0}/{1}", new Object[] {DatabaseUtils
        ...
        if ((null == model) || ("".equals(model))) {
            ...
            this.metricName = MessageFormat.format("Datastore/statement/{0}/{1}/{2}",
                                                          new Object[] {DatabaseUtils.getDatastoreVendor(dbVendor),
                                                                               model, operation});
        }
    }
