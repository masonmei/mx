...
import com.newrelic.deps.ch.qos.logback.core.joran.spi.ConsoleTarget;
import com.newrelic.deps.ch.qos.logback.core.status.Status;
import com.newrelic.deps.ch.qos.logback.core.status.WarnStatus;
import com.newrelic.deps.ch.qos.logback.core.util.EnvUtil;
...
public class ConsoleAppender<E> extends OutputStreamAppender<E> {
    ...
    private void targetWarn(String val) {
        Status status =
                new WarnStatus("[" + val + "] should be one of " + Arrays.toString(ConsoleTarget.values()), this);
    ...
    private OutputStream getTargetStreamForWindows(OutputStream targetStream) {
        try {
            ...
            Object windowsAnsiOutputStream = OptionHelper
