 ...
 * {@link ConnectionSource} that obtains a {@link DataSource} from a
 * JNDI provider and uses it to obtain a {@link Connection}. It is
 ...
 * access of {@link DataSource}s. In this way one can take advantage
