...
import com.newrelic.deps.ch.qos.logback.classic.spi.ThrowableProxy;
import com.newrelic.deps.ch.qos.logback.core.CoreConstants;
import com.newrelic.deps.ch.qos.logback.core.boolex.JaninoEventEvaluatorBase;
import com.newrelic.deps.ch.qos.logback.core.boolex.Matcher;

public class JaninoEventEvaluator extends
    JaninoEventEvaluatorBase<ILoggingEvent> {

  public final static String IMPORT_LEVEL = "import com.newrelic.deps.ch.qos.logback.classic.Level;\r\n";
