...
import com.newrelic.deps.ch.qos.logback.classic.gaffer.GafferUtil;
import com.newrelic.deps.ch.qos.logback.classic.util.EnvUtil;
...
import com.newrelic.deps.ch.qos.logback.core.joran.spi.ConfigurationWatchList;
import com.newrelic.deps.ch.qos.logback.core.joran.util.ConfigurationWatchListUtil;
import com.newrelic.deps.ch.qos.logback.core.status.StatusChecker;
...
import static com.newrelic.deps.ch.qos.logback.core.CoreConstants.MILLIS_IN_ONE_SECOND;
