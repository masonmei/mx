...
import com.newrelic.deps.org.slf4j.spi.LocationAwareLogger;

import com.newrelic.deps.ch.qos.logback.classic.spi.ILoggingEvent;
import com.newrelic.deps.ch.qos.logback.classic.spi.LoggerRemoteView;
import com.newrelic.deps.ch.qos.logback.classic.spi.LoggingEvent;
import com.newrelic.deps.ch.qos.logback.core.Appender;
import com.newrelic.deps.ch.qos.logback.core.CoreConstants;
import com.newrelic.deps.ch.qos.logback.core.spi.AppenderAttachable;
import com.newrelic.deps.ch.qos.logback.core.spi.AppenderAttachableImpl;
import com.newrelic.deps.ch.qos.logback.core.spi.FilterReply;

public final class Logger implements com.newrelic.deps.org.slf4j.Logger, LocationAwareLogger,
   ...
   * information.
   */
  public static final String FQCN = com.newrelic.deps.ch.qos.logback.classic.Logger.class
      .getName();
