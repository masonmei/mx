...
package com.newrelic.deps.com.google.common.cache;

import static com.newrelic.deps.com.google.common.base.Preconditions.checkNotNull;
import static com.newrelic.deps.com.google.common.base.Preconditions.checkState;
import static com.newrelic.deps.com.google.common.cache.CacheBuilder.NULL_TICKER;
import static com.newrelic.deps.com.google.common.cache.CacheBuilder.UNSET_INT;
import static com.newrelic.deps.com.google.common.util.concurrent.MoreExecutors.directExecutor;
import static com.newrelic.deps.com.google.common.util.concurrent.Uninterruptibles.getUninterruptibly;
import static java.util.concurrent.TimeUnit.NANOSECONDS;

import com.newrelic.deps.com.google.common.annotations.GwtCompatible;
import com.newrelic.deps.com.google.common.annotations.GwtIncompatible;
import com.newrelic.deps.com.google.common.annotations.VisibleForTesting;
import com.newrelic.deps.com.google.common.base.Equivalence;
import com.newrelic.deps.com.google.common.base.Function;
import com.newrelic.deps.com.google.common.base.Stopwatch;
import com.newrelic.deps.com.google.common.base.Ticker;
import com.newrelic.deps.com.google.common.cache.AbstractCache.SimpleStatsCounter;
import com.newrelic.deps.com.google.common.cache.AbstractCache.StatsCounter;
import com.newrelic.deps.com.google.common.cache.CacheBuilder.NullListener;
import com.newrelic.deps.com.google.common.cache.CacheBuilder.OneWeigher;
import com.newrelic.deps.com.google.common.cache.CacheLoader.InvalidCacheLoadException;
import com.newrelic.deps.com.google.common.cache.CacheLoader.UnsupportedLoadingOperationException;
import com.newrelic.deps.com.google.common.collect.AbstractSequentialIterator;
...
import com.newrelic.deps.com.google.common.primitives.Ints;
import com.newrelic.deps.com.google.common.util.concurrent.ExecutionError;
import com.newrelic.deps.com.google.common.util.concurrent.Futures;
import com.newrelic.deps.com.google.common.util.concurrent.ListenableFuture;
import com.newrelic.deps.com.google.common.util.concurrent.SettableFuture;
import com.newrelic.deps.com.google.common.util.concurrent.UncheckedExecutionException;
import com.newrelic.deps.com.google.common.util.concurrent.Uninterruptibles;
