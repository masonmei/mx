...
import com.newrelic.deps.com.google.common.hash.BloomFilterStrategies.BitArray;
import com.newrelic.deps.com.google.common.primitives.SignedBytes;
import com.newrelic.deps.com.google.common.primitives.UnsignedBytes;
...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
     ...
     */
    public static <T> BloomFilter<T> create(Funnel<? super T> funnel, int expectedInsertions /* n */, double fpp) {
        return create(funnel, expectedInsertions, fpp, DEFAULT_STRATEGY);
    }

    @VisibleForTesting
    static <T> BloomFilter<T> create(Funnel<? super T> funnel, int expectedInsertions /* n */, double fpp,
                                     Strategy strategy) {
        checkNotNull(funnel);
     ...
     * @return a {@code BloomFilter}
     */
    public static <T> BloomFilter<T> create(Funnel<? super T> funnel, int expectedInsertions /* n */) {
    ...
    public static <T> BloomFilter<T> readFrom(InputStream in, Funnel<T> funnel) throws IOException {
        ...
        try {
            ...
            IOException ioException =
                    new IOException("Unable to deserialize BloomFilter from InputStream." + " strategyOrdinal: "
                                            + strategyOrdinal + " numHashFunctions: " + numHashFunctions
   ...
   */
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (object instanceof BloomFilter) {
            ...
            return this.numHashFunctions == that.numHashFunctions && this.funnel.equals(that.funnel) && this.bits
                                                                                                                .equals(that.bits)
                           && this.strategy.equals(that.strategy);
        }
        return false;
