...
import com.newrelic.deps.org.apache.http.HttpResponseInterceptor;
import com.newrelic.deps.org.apache.http.annotation.NotThreadSafe;
import com.newrelic.deps.org.apache.http.auth.AuthSchemeProvider;
import com.newrelic.deps.org.apache.http.client.AuthenticationStrategy;
import com.newrelic.deps.org.apache.http.client.BackoffManager;
import com.newrelic.deps.org.apache.http.client.ConnectionBackoffStrategy;
import com.newrelic.deps.org.apache.http.client.CookieStore;
...
import com.newrelic.deps.org.apache.http.client.RedirectStrategy;
import com.newrelic.deps.org.apache.http.client.ServiceUnavailableRetryStrategy;
import com.newrelic.deps.org.apache.http.client.UserTokenHandler;
import com.newrelic.deps.org.apache.http.client.config.AuthSchemes;
import com.newrelic.deps.org.apache.http.client.config.CookieSpecs;
import com.newrelic.deps.org.apache.http.client.config.RequestConfig;
import com.newrelic.deps.org.apache.http.client.protocol.RequestAcceptEncoding;
import com.newrelic.deps.org.apache.http.client.protocol.RequestAddCookies;
import com.newrelic.deps.org.apache.http.client.protocol.RequestAuthCache;
import com.newrelic.deps.org.apache.http.client.protocol.RequestClientConnControl;
import com.newrelic.deps.org.apache.http.client.protocol.RequestDefaultHeaders;
import com.newrelic.deps.org.apache.http.client.protocol.RequestExpectContinue;
import com.newrelic.deps.org.apache.http.client.protocol.ResponseContentEncoding;
import com.newrelic.deps.org.apache.http.client.protocol.ResponseProcessCookies;
import com.newrelic.deps.org.apache.http.config.ConnectionConfig;
import com.newrelic.deps.org.apache.http.config.Lookup;
import com.newrelic.deps.org.apache.http.config.RegistryBuilder;
...
import com.newrelic.deps.org.apache.http.conn.SchemePortResolver;
import com.newrelic.deps.org.apache.http.conn.routing.HttpRoutePlanner;
import com.newrelic.deps.org.apache.http.conn.socket.ConnectionSocketFactory;
import com.newrelic.deps.org.apache.http.conn.socket.LayeredConnectionSocketFactory;
import com.newrelic.deps.org.apache.http.conn.socket.PlainConnectionSocketFactory;
import com.newrelic.deps.org.apache.http.conn.ssl.SSLConnectionSocketFactory;
import com.newrelic.deps.org.apache.http.conn.ssl.SSLContexts;
import com.newrelic.deps.org.apache.http.conn.ssl.X509HostnameVerifier;
import com.newrelic.deps.org.apache.http.cookie.CookieSpecProvider;
import com.newrelic.deps.org.apache.http.impl.DefaultConnectionReuseStrategy;
import com.newrelic.deps.org.apache.http.impl.NoConnectionReuseStrategy;
import com.newrelic.deps.org.apache.http.impl.auth.BasicSchemeFactory;
import com.newrelic.deps.org.apache.http.impl.auth.DigestSchemeFactory;
import com.newrelic.deps.org.apache.http.impl.auth.KerberosSchemeFactory;
import com.newrelic.deps.org.apache.http.impl.auth.NTLMSchemeFactory;
import com.newrelic.deps.org.apache.http.impl.auth.SPNegoSchemeFactory;
import com.newrelic.deps.org.apache.http.impl.conn.DefaultProxyRoutePlanner;
import com.newrelic.deps.org.apache.http.impl.conn.DefaultRoutePlanner;
import com.newrelic.deps.org.apache.http.impl.conn.DefaultSchemePortResolver;
import com.newrelic.deps.org.apache.http.impl.conn.PoolingHttpClientConnectionManager;
import com.newrelic.deps.org.apache.http.impl.conn.SystemDefaultRoutePlanner;
import com.newrelic.deps.org.apache.http.impl.cookie.BestMatchSpecFactory;
import com.newrelic.deps.org.apache.http.impl.cookie.BrowserCompatSpecFactory;
import com.newrelic.deps.org.apache.http.impl.cookie.IgnoreSpecFactory;
import com.newrelic.deps.org.apache.http.impl.cookie.NetscapeDraftSpecFactory;
import com.newrelic.deps.org.apache.http.impl.cookie.RFC2109SpecFactory;
import com.newrelic.deps.org.apache.http.impl.cookie.RFC2965SpecFactory;
import com.newrelic.deps.org.apache.http.impl.execchain.BackoffStrategyExec;
import com.newrelic.deps.org.apache.http.impl.execchain.ClientExecChain;
import com.newrelic.deps.org.apache.http.impl.execchain.MainClientExec;
import com.newrelic.deps.org.apache.http.impl.execchain.ProtocolExec;
import com.newrelic.deps.org.apache.http.impl.execchain.RedirectExec;
import com.newrelic.deps.org.apache.http.impl.execchain.RetryExec;
import com.newrelic.deps.org.apache.http.impl.execchain.ServiceUnavailableRetryExec;
import com.newrelic.deps.org.apache.http.protocol.HttpProcessor;
import com.newrelic.deps.org.apache.http.protocol.HttpProcessorBuilder;
...
import com.newrelic.deps.org.apache.http.util.TextUtils;
