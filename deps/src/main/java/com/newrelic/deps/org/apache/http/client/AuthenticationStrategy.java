...
package com.newrelic.deps.org.apache.http.client;
...
public interface AuthenticationStrategy {
     ...
     */
    Map<String, Header> getChallenges(HttpHost authhost, HttpResponse response, HttpContext context) throws
     ...
     *  challenges is not valid or malformed.
     */
    Queue<AuthOption> select(Map<String, Header> challenges, HttpHost authhost, HttpResponse response,
