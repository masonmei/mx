...
package com.newrelic.deps.org.apache.http.conn.socket;
...
public interface ConnectionSocketFactory {
     ...
     */
    Socket connectSocket(int connectTimeout, Socket sock, HttpHost host, InetSocketAddress remoteAddress,
