...
public class Rule {
    ...
    private static String createResourceName(NameType nameType, RuleType rt, String lang) {
        return String.format("com/newrelic/deps/org/apache/commons/codec/language/bm/%s_%s_%s.txt", nameType.getName(), rt.getName(), lang);
    }
    ...
    private static Scanner createScanner(String lang) {
        String resName = String.format("com/newrelic/deps/org/apache/commons/codec/language/bm/%s.txt", lang);
        InputStream rulesIS = Languages.class.getClassLoader().getResourceAsStream(resName);
