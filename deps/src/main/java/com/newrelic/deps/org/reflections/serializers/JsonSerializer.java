...
import com.newrelic.deps.com.google.common.collect.*;
import com.newrelic.deps.com.google.common.io.Files;
import com.newrelic.deps.com.google.gson.*;
    ...
    private Gson getGson() {
        if (gson == null) {
            gson = new GsonBuilder()
                    .registerTypeAdapter(Multimap.class, new com.newrelic.deps.com.google.gson.JsonSerializer<Multimap>() {
